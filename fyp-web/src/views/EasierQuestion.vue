...
<div class="w-full container mx-auto px-4">
  ...
  <div class="container mx-auto sm:px-4 mt-4 mb-5">
    ...
    <button
            class="mt-4 mb-10 float-right group relative flex justify-center py-3 px-6 border border-transparent font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            type="submit"
            @click="check"
        >
          Check
