    ...
    <div class="min-h-full flex items-center justify-center py-6 px-4 sm:px-6 lg:px-8">
      <div class="w-5/6 space-y-4">
        <h2 class="text-left font-medium text-gray-900">
          ...
          <div class="text-md">You can get some ideas from the gif images, and choose most appropriate one to describe your question.</div>
        </h2>
        <div class="creation_form">
          <div class="border rounded-lg shadow-lg bg-white px-4">
            <div class="mt-4 mb-4 border-double border-4 border-cyan-600 flex items-center pl-4 rounded dark:border-gray-700">
                ...
                <div>
                    <h5 class="block mt-5 mb-3 text-lg font-medium text-gray-900 dark:text-gray-300">Traditional Parsons Problem</h5>
            ...
            <div class="mt-4 mb-4 border-double border-4 border-cyan-600 flex items-center pl-4 rounded dark:border-gray-700">
                ...
                <img src="../images/traditional.gif" class="float-left w-120 h-80 m-5"/>
                <div>
                    <h5 class="block mt-5 mb-3 text-lg font-medium text-gray-900 dark:text-gray-300">Context</h5>
                    <p class="block text-lg font-medium text-gray-900 dark:text-gray-300">Some description</p>
                </div>  
            </div>
            <div class="mt-4 mb-4 border-double border-4 border-cyan-600 flex items-center pl-4 rounded dark:border-gray-700">
            ...
            <div class="mt-4 mb-4 border-double border-4 border-cyan-600 flex items-center pl-4 rounded dark:border-gray-700">
                ...
                <img src="../images/traditional.gif" class="float-left w-120 h-80 m-5"/>
                <div>
                    <h5 class="block mt-5 mb-3 text-lg font-medium text-gray-900 dark:text-gray-300">Multiple Steps</h5>
                    <p class="block text-lg font-medium text-gray-900 dark:text-gray-300">Some description</p>
                </div>  
            </div>
            <div class="mt-4 mb-4 border-double border-4 border-cyan-600 flex items-center pl-4 rounded dark:border-gray-700">
            ...
            <div class="mt-4 mb-4 border-double border-4 border-cyan-600 flex items-center pl-4 rounded dark:border-gray-700">
                ...
                <img src="../images/traditional.gif" class="float-left w-120 h-80 m-5"/>
                <div>
                    <h5 class="block mt-5 mb-3 text-lg font-medium text-gray-900 dark:text-gray-300">Compare Algorithm</h5>
                    <p class="block text-lg font-medium text-gray-900 dark:text-gray-300">Some description</p>
                </div>  
            </div>
            <div class="mt-4 mb-4 border-double border-4 border-cyan-600 flex items-center pl-4 rounded dark:border-gray-700">
